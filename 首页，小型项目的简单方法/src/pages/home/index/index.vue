<template>
    <div class="app">
<!--头部-->
        <div :class="{header:true,headRed:isHeadRed}">
            <span class="classify"><img src="../../../assets/images/common/class.png"/></span>
...
<!--轮播图-->
 ...
 <!--分类导航       -->
        <div class="main-class-wrap">
            <div class="main-class" v-for="(item,index) in navList" :key="index" @click="$router.push('/')">
...
<!--分类详细信息        -->
        ...
        <div class="content" :key="index" v-if="(index+1)%2==1">
            ...
            <div class="content-up">
                ...
                <div class="content-up-r">
                    <div class="up-r" v-for="(item2,index2) in item.items.slice(1,3)" :key="index2">
                        <div>
            ...
            <div class="content-down">
                <div class="down-con" v-for="(item2,index2) in item.items.slice(3,7)" :key="index2">
    ...
    <!--男装-->
        <div class="content" :key="index" v-else>
            <div :class="'content-title'+index">—— {{item.title}} ——</div>
            <div class="content-up">
                <div class="content-up-l" v-for="(item2,index2) in item.items.slice(0,2)">
            ...
            <!--内容下面-->
            <div class="content-down">
                <div class="down-con" v-for="(item2,index2) in item.items.slice(2)">
                    <div class="down-con-tit">{{item2.title}}</div>
                    <div class="down-con-img"><img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item2.image"/></div>
                    <div class="down-con-price">￥{{item2.price}}</div>
    ...
    <div class="ulike-wrap">
        ...
        <div class="ulike-con-wrap">
            <div class="ulick-con" v-for="(item,index) in ulikeGoods" :key="index">
...
<script>
    ...
    export default {
        ...
        created(){
            ...
            this.$axios.get(process.env.VUE_APP_API+"/home/index/nav?token="+process.env.VUE_APP_TOKEN).then(res=>{
