<template>
    <div>
        ...
        <div class='user-info-wrap'>
            ...
            <div class='points'>我的积分：{{userInfo.points?userInfo.points:0}}</div>
        </div>
...
<style scoped>
    ...
    .user-info-wrap{width:100%;height:2.8rem;background-image:url("../../../assets/images/user/my/mybg.png");background-size:100%;background-repeat:no-repeat;background-position: top;position: relative;z-index:1;}
