    ...
    <div class="page">
        <div class='reviews-main'>
            ...
            <div class='reviews-wrap'>
                <div class='reviews-list' v-for="(item,index) in reviewsList" :key="index">
                    <div class='uinfo'>
    ...
    export default {
        ...
        methods:{
            ...mapActions({
                ...
                getViewsPage:"reviews/getViewsPage"
            }),
        },
        created(){
            this.pullUp=new PullUp();
            this.gid=this.$route.query.gid;
            this.getViews({gid:this.gid,success:()=>{
                // 1、当前第几页，最大是几页，2、回调函数
                this.pullUp.init({"curPage":1,"maxPage":this.pageInfo.pagenum,"offsetBottom":100},(curPage)=>{
                    this.getViewsPage({gid:this.gid,page:curPage})
                })
            }})
        },
        destroyed(){
            this.pullUp.uneventSrcoll()//离开评价页面，卸载分页侦听事件，以免别的页面也收到影响
        }
    }
</script>
...
<style scoped>
    ...
    .reviews-main{width:100%;background-color: #FFFFFF;margin-top:0.2rem;overflow:hidden;padding-bottom: 0.5rem}
